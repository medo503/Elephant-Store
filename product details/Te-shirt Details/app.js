...
const slider_load = () => {
    setTimeout(() => {
        header.style.background = "url('8.jpg') no-repeat center center/cover";
        header_dur.innerText = "";
    ...
    setTimeout(() => {
        header.style.background = "url('Sweet-shirt slider home/8.jpg') no-repeat center center/cover";
        header_dur.innerText = "";
    ...
    setTimeout(() => {
        header.style.background = "url('Sweet-shirt slider home/4.jpg') no-repeat center center/cover";
        header_dur.innerText = "";
...
video_1[0].addEventListener('click', () => {
    videos.src = "WhatsApp Video 2023-03-14 at 16.12.54.mp4";
    videos.play();
    title_video[0].innerText = "Print your design on t-shirt";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
...
const movies = [
    {
        ...
        {
            id: 11,
            img: "All Products/Sweet-Shirt Section/13.jpg",
            title: "Shershaah",
            letter: "s",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 10,
            img: "All Products/Sweet-Shirt Section/6.jpg",
            title: "Shiddat",
            letter: "s",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 9,
            img: "All Products/Sweet-Pance Section/2.jpeg",
            title: "Snake Eyes",
            letter: "s",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 8,
            img: "All Products/Sweet-Pance Section/7.jpg",
            title: "Take Point",
            letter: "t",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 7,
            img: "All Products/Sweet-Pance Section/5.jpg",
            title: "The Manor",
            letter: "t",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 6,
            img: "All Products/Te-Shirt Section/14.jpg",
        ...
        {
            id: 5,
            img: "All Products/Te-Shirt Section/56.jpg",
            title: "The Out Post",
            letter: "t",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 4,
            img: "All Products/Te-Shirt Section/40.jpg",
            title: "The Vault",
            letter: "t",
            genre1: "none",
            genre2: "none",
        ...
        {
            id: 3,
            img: "All Products/Te-Shirt Section/4.jpg",
            title: "Venom 2",
            letter: "v",
            genre1: "none",
            genre2: "",
